...
export default function App() {
  ...
  const options2 = [
    ...
    { text: "Arifni Choirussabila", value: " Arifni Choirussabila" },
    ...
    { text: "Imanuel Gidion Kurniawan", value: " Imanuel Gidion Kurniawan" },
  ...
  const handleConfirm = async (event, action) => {
    ...
    if (action === "edit") {
      ...
      const res = await fetch(`http://10.24.7.70:8080/addRESERVE2/${ruang}/`, {
        method: "PUT",
        headers: {
          "Content-Type": "application/json",
          // Authorization: `Bearer ${token}`,
        ...
        fields={[
          {
            ...
            config: { label: "Room", md: 2, sm: 6, required: true },
          },
          {
            name: "series",
            type: "select",
